...
This project is indexed by GitNexus as **create-evo-lite** (991 symbols, 1827 relationships, 88 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
